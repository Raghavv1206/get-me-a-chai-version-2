        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="backdrop-blur-md bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700 rounded-3xl p-12 md:p-16 shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <button className="group px-10 py-5 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold text-lg rounded-xl shadow-xl shadow-purple-500/50 hover:shadow-purple-500/70 transition-all duration-300 hover:scale-105">
              ...
              <button className="px-10 py-5 bg-gray-800/70 text-white font-bold text-lg rounded-xl border-2 border-gray-700 backdrop-blur-sm hover:bg-gray-800 hover:border-purple-500/50 transition-all duration-300">
                Watch Demo
              </button>
            </div>
