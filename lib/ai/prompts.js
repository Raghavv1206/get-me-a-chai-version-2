...
- Use numbered lists (1., 2., 3.) for breakdowns
- Separate sections with blank lines
- Write section headings as plain text followed by a colon
...
Format as JSON:
{
  ...
  "story": "Full campaign story with all sections in plain text"
}`;
}
